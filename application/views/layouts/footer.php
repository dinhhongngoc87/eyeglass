            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <ul class="footer-links">
                        <li><a href="<?php echo base_url('chuyen-muc/L001/'); ?>">Gọng kính</a></li>
                        <li><a href="<?php echo base_url('chuyen-muc/L003/'); ?>">Kính râm </a></li>
                        <li><a href="<?php echo base_url('chuyen-muc/L002/'); ?>">Tròng kính</a></li>
                        <li><a href="<?php echo base_url('chuyen-muc/L004/'); ?>">Phụ kiện</a></li>
